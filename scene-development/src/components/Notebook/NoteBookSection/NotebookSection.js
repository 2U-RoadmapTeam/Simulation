  ...
  render() {
    return (
      <div tabIndex={-1} className="notebook-section card">
        <div
          tabIndex={-1}
          className={"card-header" + (this.props.focused ? " active" : "")}
        >
          <div className="arrow"></div>
          <h4
            tabIndex={-1}
            className="incomplete"
            aria-label={this.props.text + "heading"}
          >
            <IconHexagon
              style={{
                position: "absolute",
                color: this.props.focused ? "white" : colors.navy1,
                height: this.props.focused ? "32px" : "15px",
                top: this.props.focused ? "15px" : "24px",
                left: this.props.focused ? "15px" : "22px",
              }}
            />
            <p tabIndex={-1} className="listIndex">
              {this.props.index}{" "}
            </p>
            <button
              aria-label={
                this.props.text +
                " menu button. Select to enter the " +
                this.props.text +
                " menu pane."
              }
        ...
        <div tabIndex={-1} className={"collapse-wrapper " + this.props.text}>
          <Collapse
          ...
          >
            {this.props.focused ? (
              <NotebookPopout
                ...
                section={this.props.text}
                tab={this.props.focused ? null : -1}
              />
            ) : null}
          </Collapse>
        </div>
