...
//     return (
//       <div>
//         <div className="progress">{this.renderProgressBar()}</div>
...
//         className={
//           "progress-bar" +
//           (this.props.currentPage >= index + 1 ? " active" : "")
//         }
//         onClick={() => {
...
//           {this.props.tasks[this.props.currentPage - 1].instruction}
//         </p>
//       );
//     } else {
//       return <p className="section-instruction">0. No tasks found</p>;
//     }
//   };
...
//     if (
//       prevProps.modal.display === true &&
//       this.props.modal.display === undefined &&
//       this.props.modal.type === "PROTOCOL_READ"
//     ) {
//       this.pageInstruction.focus();
//     }
//   }
...
//           style={{ display: this.props.notesView ? "none" : null }}
//         >
...
//               <button
//                 aria-label="Protocol menu button. Select to hide the Protocol instructions and simulation and display the menu."
...
//                 aria-label="Notes button. Select to display any notes you’ve made throughout the simulation."
//                 className="protocol-notebook-btn"
//               >
//                 <IconNotebook
...
//               <button
//                 aria-label="Previous button. Select to display the previous step in the protocol."
//                 className={this.prevBtnClass()}
//                 onClick={this.prevClicked}
//                 style={{
//                   visibility:
//                     this.props.currentPage === 1 ? "hidden" : "visible",
//                 }}
//               >
//                 <IconStart
//                   style={{
...
//                 className="indicator"
//                 onClick={() => {
//                   this.props.goProtocolPage(this.props.focusedPage + 1);
//                 }}
//               >
//                 <span>
//                   {this.props.focusedPage +
...
//                     String.fromCharCode(97 + this.props.focusedTask)}
//                 </span>
//                 <IconHexagon style={{ color: colors.navy1, height: "46px" }} />
//               </div>
//               <button
//                 aria-label="Next button. Select to display the next step in the protocol."
//                 className={
//                   "protocol-btn" +
//                   (this.props.focusedPage >= this.props.currentPage ||
//                   (this.props.currentPage === this.props.totalPages &&
//                     this.props.taskPages[this.props.focusedPage].complete ===
//                       true)
//                     ? " active"
//                     : "")
//                 }
...
//                 style={{
//                   visibility: this.blockNextBtn() ? "hidden" : "visible",
//                 }}
//               >
//                 <IconStart
